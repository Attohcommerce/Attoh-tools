...
For every keyword you KEEP, write "uitleg": ONE sentence in Dutch that says exactly WHAT the item is plus 1–2 visual cues to recognise it on a product photo (e.g. "Een wijdvallende gehaakte strandjurk met open patroon — herkenbaar aan het grove haakwerk en de doorschijnende structuur."). This sentence is used later by an AI scraper to verify product photos, because competitors rarely use these exact words in their titles.
