...
export async function reviewVerdelingFinal(rows, market, storeUrl, ctx = {}) {
  ...
  // ctx: { months: ["sep","okt","nov","dec"], seasons: ["spring","summer"] }
...
- a NOVELTY/GIFT item rather than a fashion purchase ("christmas t shirts", "funny sweatshirt", "ugly christmas jumper", matching family pyjamas) — these boutiques sell clothing people wear, not printed gifts.${seasonBlock}
