...
- "share" = fraction of "target" reserved for that type (0.05–0.6). Shares of all focus entries together never exceed 0.8 — the rest is filled by the engine with the best remaining seasonal keywords.
...
- Everything in "note", "notes" and "summary" is Dutch, short and concrete.`,
  ...
  if (sumShare > 0.8) focus = focus.map((f) => ({ ...f, share: Math.round((f.share * 0.8 / sumShare) * 100) / 100 }));
