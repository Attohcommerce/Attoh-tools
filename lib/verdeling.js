...
const PRINTABLE_RE = /\b(t ?shirts?|tees?|sweatshirts?|jumpers?|sweaters?|hoodies?|pyjamas?|pajamas?|onesies?)\b/;
...
const SPORT_PAIR_RE =
  /\b(wrestling|tennis|basketball|running|jogging|workout|gym|soccer|football|golf|ski|snowboard|cycling|climbing|walking|volleyball|baseball|softball|track)\b[\s\S]*\b(shoes?|boots?|sneakers?|trainers?|jackets?|pants?|shorts?|gear|cleats?|jerseys?|spikes?)\b/;
