...
export const STORE_PROFILES = {
  ...
  "shapeswardrobe.com": {
    ...
    /* De store voert geen plus size. "plus size dresses" en "curvy jeans"
       kwamen in de run van 25-9 gewoon mee — dan scrapet de scraper maten
       die er niet zijn. */
    blockWords: ["plus size", "plussize", "curve", "curvy"],
  },
