...
export async function formatRunTab(sheetId, tabId) {
  ...
  const COLS = [180, 330, 165, 165, 95, 95, 150, 130, 170]; // A t/m I (I = Collectie)
  ...
  await spreadsheetBatchUpdate(sheetId, [
    ...
    {
      repeatCell: {
        range: { sheetId: tabId, startRowIndex: 1, endRowIndex: 5000, startColumnIndex: 0, endColumnIndex: 9 },
    ...
    {
      setBasicFilter: {
        filter: { range: { sheetId: tabId, startRowIndex: 0, endRowIndex: 5000, startColumnIndex: 0, endColumnIndex: 9 } },
      },
    },
