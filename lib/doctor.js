...
export function runDoctor(products, opts = {}) {
  ...
  if (opts.guides) {
    ...
    findings.push({
      ...
      why: "Bewust toegestaan als vangnet — telt niet mee in de score. Beter: in de Size Guide-pagina met AliExpress zoeken op foto aanzetten, dan komen hier de echte maten.",
